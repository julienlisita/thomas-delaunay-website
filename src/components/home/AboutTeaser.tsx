    ...
    <Section>
      <SectionWrapper className="max-w-6xl mx-auto">
        ...
        <Split className="mt-4">
          ...
          <div>
            <Lead className="mb-4">
              Ancien nageur et passionné de surf, j’ai toujours vu le mouvement comme une source d’équilibre.
              Aujourd’hui, j’accompagne chacun à retrouver cette harmonie à travers une approche douce, réaliste et personnalisée.
            </Lead>
