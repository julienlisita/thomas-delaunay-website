    ...
    <Section>
      <SectionWrapper className="max-w-6xl mx-auto">
        ...
        <Lead className="text-center mb-6">
          ...
          aider à retrouver équilibre, énergie et confiance, grâce à un accompagnement sur mesure
          fondé sur l’écoute, la progression et le plaisir du mouvement.
          <br />
          <br />
          Je crois en une discipline douce : pas de pression, pas de performance imposée — seulement
          une démarche réaliste, adaptée, et tournée vers votre bien-être global.
        </Lead>
